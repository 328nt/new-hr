...
<section class="top_place section_padding">
    <div class="container">
        ...
        {{-- <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single_place">
                            <img src="fe/img/single_place_2.png" alt="">
                            <div class="hover_Text d-flex align-items-end justify-content-between">
                                <div class="hover_text_iner">
                                    <a href="#" class="place_btn">travel</a>
                                    <h3>Saintmartine Iceland</h3>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single_place">
                            <img src="fe/img/single_place_3.png" alt="">
                            <div class="hover_Text d-flex align-items-end justify-content-between">
                                <div class="hover_text_iner">
                                    <a href="#" class="place_btn">travel</a>
                                    <h3>Saintmartine Iceland</h3>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single_place">
                            <img src="fe/img/single_place_4.png" alt="">
                            <div class="hover_Text d-flex align-items-end justify-content-between">
                                <div class="hover_text_iner">
                                    <a href="#" class="place_btn">travel</a>
                                    <h3>Saintmartine Iceland</h3>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_ihotel_list">
                            <img src="fe/img/services_1.png" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_ihotel_list">
                            <img src="fe/img/services_2.png" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_ihotel_list">
                            <img src="fe/img/services_3.png" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_ihotel_list">
                            <img src="fe/img/services_4.png" alt="">
